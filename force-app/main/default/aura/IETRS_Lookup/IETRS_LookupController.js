({
  doInit: function (component, event, helper){
      ...
      console.log('--primaryDisplayField*inside init*'+primaryDisplayField);
      ...
      console.log('--selectedObject.Name-'+selectedObject);
      if(selectedObject != undefined)
      	component.set('v.selectedObjectDisplayName',selectedObject.Name);
  ...
  removeSelectedOption : function(component, event, helper) {
    var selectedObject = JSON.parse(JSON.stringify(component.get('v.selectedObject')));
      if(selectedObject == null)
          selectedObject ='';
    console.log('---selecte object1111111111',selectedObject);
     
    var selectedLookupRemoved = component.getEvent("selectedLookupRemoved");
      console.log('--selectedLookupRemoved--',selectedLookupRemoved);
    selectedLookupRemoved.setParams({
      ...
      console.log('--selectedLookupRemoved-1111-',selectedLookupRemoved);
     component.set('v.selectedObject',undefined);
    component.set('v.selectedObjectDisplayName','');
