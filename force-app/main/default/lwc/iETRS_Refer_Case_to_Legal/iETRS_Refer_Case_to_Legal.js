...
export default class IETRS_Refer_Case_to_Legal extends LightningElement {
    ...
    assignToHearingsHandler(){
        ...
        assignToHearingOrLE({
            ...
            strShareWithFieldName: 'IETRS_Privileged__c'
        })
        .then(result => {
            const event = new ShowToastEvent({
                title: 'Success',
                variant: 'success',
                message: 'Case Successfully Referred to Legal.',
            });
            this.dispatchEvent(event);
            this.modalVisible = false;
